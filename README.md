...
### Vision
This project aims to make neural networks more efficient, powerful and easier to use for individuals. By correcting current inefficiencies and re-imagining these 'mini brains' we can bring learning machines to local devices thus upending the monopoly companies currently control.
